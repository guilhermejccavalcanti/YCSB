   ...
   */
    ...
    protected static NumberGenerator getFieldLengthGenerator(Properties p) throws WorkloadException {
        ...
        if (fieldlengthdistribution.compareTo("constant") == 0) {
            ...
            if (fieldlengthdistribution.compareTo("uniform") == 0) {
                fieldlengthgenerator = new UniformIntegerGenerator(1, fieldlength);
            } else {
                if (fieldlengthdistribution.compareTo("zipfian") == 0) {
                    fieldlengthgenerator = new ZipfianGenerator(1, fieldlength);
                } else {
                    if (fieldlengthdistribution.compareTo("histogram") == 0) {
                        try {
   ...
   */
    ...
    public void init(Properties p) throws WorkloadException {
        ...
        if (requestdistrib.compareTo("uniform") == 0) {
            ...
            if (requestdistrib.compareTo("sequential") == 0) {
                ...
                if (requestdistrib.compareTo("zipfian") == 0) {
                    ...
                    if (requestdistrib.compareTo("latest") == 0) {
                        keychooser = new SkewedLatestGenerator(transactioninsertkeysequence);
                    } else {
                        if (requestdistrib.equals("hotspot")) {
        ...
        if (scanlengthdistrib.compareTo("uniform") == 0) {
            ...
            if (scanlengthdistrib.compareTo("zipfian") == 0) {
